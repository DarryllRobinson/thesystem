          ...
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
              ...
              <h5 className={classes.description}>
                We have the standard options to suit your budget but if you don
                {"'"}t see something that works for you, please contact us.
              </h5>
              <br />
            </GridItem>
          </GridContainer>
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={3}>
            <Card className={themes.priceCard}>
              <form className={classes.form}>
                <CardBody>
                  <div className={themes.priceDivTitle}>FULL SYSTEM ACCESS</div>
                  <DvrIcon className={themes.priceIcon} />
                  <div className={themes.pricePrice}>R50 pm</div>
                </CardBody>
                <div className={themes.priceDescription}>
                  Unlimited access to The System for all your collections
                  requirements
                </div>
                <CardFooter className={themes.priceFooter}>
                  <Button className={themes.priceButton}>Choose plan</Button>
                </CardFooter>
              </form>
            </Card>
          </GridItem>
          ...
          <GridItem xs={12} sm={12} md={3}>
            <Card className={themes.priceCard}>
              <form className={classes.form}>
                <CardBody>
                  <div className={themes.priceDivTitle}>COMBINATION</div>
                  <DvrIcon className={themes.priceIcon} />
                  <HeadsetMicIcon className={themes.priceIcon} />
                  <div className={themes.pricePrice}>R90 pm</div>
                </CardBody>
                <div className={themes.priceDescription}>
